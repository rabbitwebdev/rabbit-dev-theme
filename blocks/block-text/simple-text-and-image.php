...
$class_name = 'block-text-and-media';
...
<div <?php echo esc_attr( $anchor ); ?> class="section-block <?php echo esc_attr( $class_name ); ?>   <?php echo esc_attr( $style ); ?>  "  >
 <?php if ($animations == '1') { ?>
    ...
    <?php if ( $left_line ) : ?>
    <div class="animated-border-left" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="500" data-aos-easing="linear" ></div>
    <?php else : ?>
 <div class="animated-border"  data-aos="fade-left" data-aos-duration="1000" data-aos-delay="500" data-aos-easing="linear" ></div> 
  <?php endif; ?>
  <?php if ( $down_left ) : ?>
    <div class="animated-border-down-left"  data-aos="fade-down" data-aos-duration="1000" data-aos-delay="400"   data-aos-easing="linear" ></div>
    <?php else : ?>
 <div class="animated-border-down"  data-aos="fade-down" data-aos-duration="1000" data-aos-delay="400"   data-aos-easing="linear" ></div> 
    <?php endif; ?>
...
<?php if ( $has_background ) : ?>
    <div class="background-img-wrp <?php echo $background_image_size ; ?>">
...
<div class="row align-items-center <?php echo esc_attr( $colposition ); ?> <?php echo $reverse_block ; ?> "> <!-- Row -->
